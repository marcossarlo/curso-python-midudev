...
print("Función que devuelve la suma de los huevos de dinosaurios T-Rex (números que son pares)")
egg_list = [3, 4, 7, 5, 8, 0]
print("Lista de huevos de dinosaurios: ", egg_list)
